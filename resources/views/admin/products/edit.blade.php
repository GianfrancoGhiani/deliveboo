                    ...
                    <div class="col-12 row row-cols-lg-2 row-cols-sm-1">
                        <div class="col">
                            ...
                            <div class="pb-3">
                                ...
                                <textarea name="ingredients" id="ingredients" rows="5" class="form-control @error('ingredients') is-invalid @enderror"oninvalid="this.setCustomValidity('This field is required')" required>{{old('ingredients', $product->ingredients)}}</textarea>
                                @error('ingredients')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col">
                            ...
                            <div class="pb-3">
                                ...
                                <img id="uploadPreview" class="col-12" src="{{ $product->image_url ? asset('storage/'.old('image_url', $product->image_url)) : 'https://via.placeholder.com/300x200'}}">
                                @error('image_url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
